export const SYMPTOM_AREAS = [
  {
    ...
    symptomSummary: "Deep occipital stiffness, chronic tension headache extending to the upper shoulders, or radiating numbness down the arms.",
    rootCauses: [
      "Sustained forward flexed posture during computer/device screen exposure",
      "Overactive upper trapezius and levator scapulae compensating for weak deep cervical flexors",
      "Facet joint capsule irritation from lack of thoracic mobility"
    ],
    commonMistakes: "Relying on temporary heating pads or deep muscle massage that briefly lowers tone without strengthening deep stabilizing neck flexors or releasing upper thoracic lock.",
    jeniTreatment: [
      ...
      "Isometric deep neck stabilizer neuromuscular training"
    ],
  ...
  },
  {
    ...
    symptomSummary: "Sharp pinch when lifting arm overhead, nocturnal throbbing when sleeping on the affected shoulder, or weakness during pushing/pulling tasks.",
    rootCauses: [
      "Subacromial space compression due to poor scapular dyskinesis (improper shoulder blade rhythm)",
      "Eccentric overload of supraspinatus tendon from sudden increases in racket/throwing sports or lifting",
      "Posterior shoulder capsule tightness shifting the humeral head anteriorly"
    ],
    commonMistakes: "Stopping all movement and resting completely (which causes tendon weakening and atrophy), or solely stretching an already sensitive, impinged tendon.",
    jeniTreatment: [
  ...
  },
  {
    ...
    symptomSummary: "Catching sensation when rising from sitting, dull deep sacral fatigue, or radiating neural tension (sciatic ache) traveling into glutes and posterior thigh.",
    rootCauses: [
      "Prolonged sedentary anterior pelvic tilt disabling Gluteal kinetic firing ('Glute Amnesia')",
      "Shearing lumbar load overload due to inadequate hip hinge endurance during lifting or lifting children",
      "Segmental multifidus muscular dehydration and spasm from protective guarding"
    ],
    commonMistakes: "Relying on supportive lumbar corsets, generic foam rolling over the low back spine, or avoiding all bending instead of teaching the nervous system safe loaded spinal mechanics.",
    jeniTreatment: [
      "Decompression spinal articulation & passive directional positional preference assessment (McKenzie style differential)",
      "Targeted gluteus medius and deep transverse abdominis neuromoto activation",
      "Hip hinge retraining under clinical graded exposure",
  ...
  },
  {
    ...
    tagline: "Staircase descent pain, movie theater stiffness & patellar tendinitis",
    symptomSummary: "Ache behind or just beneath the kneecap that flares up during stair walking (especially downwards), climbing, squats, or after long drives.",
    rootCauses: [
      ...
      "Sudden spike in running mileage or jump landing velocity without adequate quadriceps deceleration capacity"
    ],
    commonMistakes: "Blaming 'bone-on-bone arthritis' prematurely or relying entirely on passive ice treatments without assessing hip abductor strength and foot arch pronation mechanics.",
    jeniTreatment: [
  ...
  },
  {
    ...
    symptomSummary: "Exotic sharp stabbing pain under heel on first steps out of bed in the morning, or achilles stiffness after periods of rest following sport.",
    rootCauses: [
      "Restricted talocrural joint dorsiflexion forcing excessive plantar fascial pronation stretching",
      "Soleus and gastrocnemius myofascial contracture reducing elastic recoil",
      "Abrupt transition to zero-drop footwear or elevated training intensity without fascial accommodation"
    ],
    commonMistakes: "Aggressive passive static stretching of an acute plantar tear or rely solely on gel heel cups without training plantar instrinsic intrinsic foot muscular dome strength.",
    jeniTreatment: [
...
export const TIMELINE_STAGES = [
  {
    ...
    passiveApproach: {
      action: "Pain meds, passive heat, ice packs & muscle relaxers",
      result: "Temporary local sensory numbing (2–4 hours). The brain continues protective neuromuscular muscle guarding. Zero underlying tissue repair or structural load tolerance adaptation."
    },
    honestApproach: {
...
export const ERGO_TIPS = {
  highRisk: {
    ...
    summary: "Your daily sedentary duration paired with current symptoms indicates active mechanical tissue degradation in your cervical and lumbar stability matrices.",
    prescription: [
      "Every 45 minutes: Execute 10 standing extension hip thrusts with chin tuck retractions.",
      "Adjust monitor top edge directly at eye level to remove 35 lbs of lever torque from C5-C6 vertebrae.",
      "Schedule a thorough clinical evaluation with Dr. Jeni immediately before neural radiculopathy sets in."
    ]
  },
  medRisk: {
    scoreRange: "45% - 74%",
    ...
    summary: "Your postural endurance is nearing its mechanical fatigue threshold. Minor compensations are beginning to trigger stiffness and end-of-day fatigue.",
    prescription: [
      "Adopt a 50/50 sit-stand protocol if desk architecture permits (standing during afternoon email blocks).",
      "Perform Thoracic Windmill rotation openings 3 times daily to lubricate mid-back facet joints.",
      "Integrate Dr. Jeni's 5-minute evening Glute bridge and scapular stabilizer routine."
    ]
  },
  lowRisk: {
    scoreRange: "0% - 44%",
    ...
    summary: "You exhibit admirable movement discipline and joint hygiene. Your current routine is supporting robust orthopedic tissue tolerance.",
    prescription: [
      ...
      "Consider an annual preventative biomechanical checkup prior to training marathon or heavy sports leagues."
    ]
  }
};
...
export const MODALITIES = [
  ...
  },
  {
    ...
    iconName: "Zap",
    description: "Using sterile, ultra-thin solid monofilament needles inserted directly into stubborn muscular hyper-irritable myofascial knots and spastic paraspinal tissue. This bypasses skin nociceptors to produce a rapid localized muscle twitch response and instant tone reduction.",
  ...
  },
  {
    ...
    iconName: "Compass",
    description: "We never treat an injury in isolation. If your knee hurts while running, we analyze your ankle dorsiflexion velocity and opposite hip gluteus control. Using high-definition slow-motion video analysis, we fix the true root mechanics causing recurring stress.",
    whyItWorks: "Replaces compensatory movement habits with permanent neuro-muscular efficiency, protecting against sports re-injury."
  },
  {
...
export const CASE_STUDIES = [
  {
    patient: "Marcus V. (34) — Marathon Runner",
    injury: "Chronic Bilateral Achilles Tendinopathy (18 months persistence)",
    previousFailedTx: "Had received 12 weeks of passive shockwave therapy and ultrasound at another clinic with persistent morning stabbing pain.",
    ...
    outcome: "Full pain-free running return at week 6. Completely completed Boston Marathon qualifier pain-free at month 4.",
    metric: "100% Calf Force Production Restoration"
  },
  {
    patient: "Elena K. (41) — Lead Architectural Designer",
    injury: "Severe Cervicogenic Headache & Right Ulnar Paresthesia (Numbness)",
    previousFailedTx: "Prescribed muscle relaxant medication and ergonomic chair replacement without symptomatic reduction in arm numbness.",
    ...
    outcome: "Arm numbness eliminated completely within 3 visits. Zero headache occurrences reported over 12-month follow-up.",
    metric: "0/10 Pain Scale achieved in 14 days"
  },
  {
    patient: "Captain Rajesh T. (29) — Commercial Aviator",
    injury: "Acute Post-Surgical Lumbar Disc Herniation Guarding (L4-L5)",
    previousFailedTx: "Told by trainers to wear back rigid braces, resulting in 40% atrophy of deep Lumbar multifidus stabilizing muscles over 6 months.",
    ...
    outcome: "Cleared for full flight commercial duty without restricted flight hours. Lifting 50lb pilot baggage completely effortlessly.",
...
export const CREDENTIALS = [
  ...
  "Zero Passive Routine Guarantee — 100% Hands-On One-on-One Physician Time"
];
